...
registerUnbound('discussbook-mobile-img', function(topic) {
    ...
    if(topic && topic.book && topic.book.volumeInfo && topic.book.volumeInfo.imageLinks){
        ...
        if(imageLinks && imageLinks.smallThumbnail){
            ...
            if(arr.length == 3){
                return new Handlebars.SafeString("<img src='https"+arr[2]+"' width=\"45\">");          
            }
            return new Handlebars.SafeString("<img src='"+thumbnailUrl+"' width=\"45\">");
        }
        ...
        var cooked = topic.post_stream.posts[0].cooked;
            ...
            if(href && href.length > 0){
                ...
                return new Handlebars.SafeString("<img src='"+href+"' width=\"45\">");  
